...
#GET SEARCH INFO
SearchInfo = Stuff()
website = ("https://www.britishorienteering.org.uk/index.php?page=0&evt_name=&evt_postcode=&evt_radius=0&evt_level=0evt_type=0&event_club=0&evt_start_d=10&evt_start_m=10&evt_start_y=2020&evt_end_d=20&evt_end_m=10&evt_end_y=2020&evt_assoc=0&evt_start=1577836800&evt_end=1585907978&perpage=100&bSearch=1&pg=results")
...
with open("timeStats.json", "r+") as stats:
...
with open("timeStats.json", "w+") as stats:
